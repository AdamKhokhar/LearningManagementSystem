...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        users = [
            ...
            {'username': 'instructor', 'email': 'instructor@example.com', 'is_staff': False, 'is_superuser': False},
        ...
        self.stdout.write(self.style.SUCCESS('\nDefault users:'))
        self.stdout.write(self.style.SUCCESS('  admin / password (admin account)'))
        self.stdout.write(self.style.SUCCESS('  instructor / password'))
        self.stdout.write(self.style.SUCCESS('  student1 / password'))
        self.stdout.write(self.style.SUCCESS('  student2 / password'))
